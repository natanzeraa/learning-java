...
public class Methods {
    ...
    */
    ...
    static void methodOne() {
     ...
     /*
        1. Information can be passed to methods as a parameter.
        2. Parameters act as variables inside the method.
    ...
    public static void main(String[] args) {
        ...
        /*
            1. When a parameter is passed to the method, it is called an argument.
            2. So, from the example bellow: fName and lName are parameters while Jackie Chan, Tom Cruise and Chuck Norris are arguments.
        */
